...
namespace CodexFlow.Core.Skills.Python;

public class PythonScaffolderSkill : ISkill
{
    public string Name => "python-scaffolder";
    public string Description => "Initialize a new Python FastAPI project with virtual environment and professional folder structure.";
    ...
    public async Task<SkillResult> ExecuteAsync(SkillContext context)
    {
        ...
        try
        {
            ...
            var args = $"\"{scriptPath}\" \"{projectName}\" --output \"{workspace}\"";
    ...
    private static string ResolveScriptPath()
    {
        ...
        var candidate = Path.Combine(baseDir, "skills", "python-scaffolder", "scripts", "scaffold.py");
        ...
        while (current != null)
        {
            ...
            {
                var slnCandidate = Path.Combine(current.FullName, "CodexFlow", "skills", "python-scaffolder", "scripts", "scaffold.py");
